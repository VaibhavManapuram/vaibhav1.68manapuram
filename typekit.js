...
window.Typekit.config = {
    "a": "646866",
    "dl": "AAABAwAAAAqpw2B7UO_Yv1JpVeeKp3fQlhurMSdWEBGMuzp4nto3pQAAAAU",
    "fi": [39496, 39498, 39500, 39497, 39499, 39501],
    "fc": [{
        "id": 39496,
        ...
        "descriptors": {"weight": "600", "style": "normal", "display": "auto", "subset_id": 2}
    }, {
        "id": 39500,
        "family": "neue-haas-grotesk-display",
        ...
        "descriptors": {"weight": "500", "style": "italic", "display": "auto", "subset_id": 2}
    }, {
        "id": 39499,
        "family": "neue-haas-grotesk-display",
        "src": "https://use.typekit.net/af/8a7571/00000000000000007735bb67/30/{format}{?primer,subset_id,fvd,v}",
        "descriptors": {"weight": "600", "style": "italic", "display": "auto", "subset_id": 2}
    }, {
        "id": 39501,
        "family": "neue-haas-grotesk-display",
    ...
    "fn": ["neue-haas-grotesk-display", ["i5", "i6", "i7", "n5", "n6", "n7"]],
    "hn": "use.typekit.net",
    "ht": "tk",
    "js": "1.20.0",
    "kt": "646866_61bf107f31a67360db61f2d5",
    "l": "typekit",
    "ps": 2,
...
/*{"k":"1.20.0","auto_updating":true,"last_published":"2021-12-26 23:13:43 UTC"}*/
;(function (window, document, undefined) {
    ...
    T.prototype.load = function (a, b, c) {
        ...
        a = c.timeout;
        var e = !!c.async, f = oa(), g = qa(this.u, f);
        c = new A(this.b, c, {
            active: function () {
                if (e) {
                    var a = K(g, f, d.i, !1);
                ...
                if (d.m) {
                    ...
                    for (var x = 0; x < a.b.length; x++) {
                        for (var va = !1, ca = 0; ca < w.length; ca++) if (a.b[x] === w[ca]) {
                            va = !0;
                            break
                        }
    ...
    Ha.prototype.load = function (a, b) {
        ...
        if (c.length) for (var e = this, f = c.length, g = 0; g < c.length; g++) Ia(this, c[g], function () {
            --f || Ja(e, d)
        }); else Ja(this, d)
    };
    ...
    function Ka() {
        var a = m.ps, b = m.ht, c = La, d = m.a, e = m.kt, f = m.js, g = m.l;
        this.m = new G(m.ping);
        this.j = a;
        this.i = b;
        this.b = c || [];
    ...
    if (m.fc) for (var W = m.fc, X = 0; X < W.length; X++) {
        ...
        if (Qa && 1 === Pa.subset_id) for (var Z = 0; Z < Fa.length; Z++) if (-1 !== Y.indexOf(Fa[Z])) {
